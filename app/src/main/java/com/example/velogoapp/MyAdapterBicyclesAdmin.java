...
public class MyAdapterBicyclesAdmin extends ArrayAdapter<Bicycles> {
    ArrayList<Bicycles> bicyclesList = new ArrayList<Bicycles>();

    public MyAdapterBicyclesAdmin(@NonNull Context context, int resource, @NonNull ArrayList<Bicycles> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        v = inflater.inflate(R.layout.my_bicycles_admin, null);

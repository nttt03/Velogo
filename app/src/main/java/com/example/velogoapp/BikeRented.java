...
public class BikeRented extends AppCompatActivity {
    ListView lstBikeRented;
    SQLiteDatabase db;
    ArrayList<Rentals> bikeRentedList = new ArrayList<Rentals>();
    MyAdapterBikeRented adapter;
    int posselected = -1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_bike_rented);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.nav_home) {
                    Intent intent = new Intent(BikeRented.this, MainActivity.class);
                    startActivity(intent);
                } else if (itemId == R.id.nav_station) {
                    Intent intent = new Intent(BikeRented.this, Stations.class);
                    startActivity(intent);
                } else if (itemId == R.id.nav_history) {
                    Intent intent = new Intent(BikeRented.this, History.class);
                    startActivity(intent);
                } else if (itemId == R.id.nav_extend) {
                    Intent intent = new Intent(BikeRented.this, Extend.class);
                    startActivity(intent);
                }
        ...
        lstBikeRented = findViewById(R.id.lstBikeRented);
    ...
    private void getHistoryList(int userID) {
        ...
        Cursor c = db.rawQuery("SELECT Bicycles.BicycleID, Bicycles.ModelName, Rentals.RentalID, " +
                        ...
                        "AND Rentals.UserID = ?" +
                        "AND Rentals.Status = ?",
                new String[]{String.valueOf(userID), "Đang thực hiện"});
        ...
        while (!c.isAfterLast()) {
            ...
            bikeRentedList.add(new Rentals(bicycleID, bicycleName, rentalID, String.valueOf(userID), stationID, rentalStart, rentalEnd, totalCost, status));
            c.moveToNext();
        }

        adapter = new MyAdapterBikeRented(this, android.R.layout.simple_list_item_1, bikeRentedList);
        lstBikeRented.setAdapter(adapter);
    }
}